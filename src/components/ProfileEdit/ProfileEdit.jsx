  ...
  return (
    <Transition.Root show={open} as={Fragment}>
      <Dialog
        ...
        onClose={setOpen}
      >
        <div className="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0 mt-10">
          <Transition.Child
            as={Fragment}
                    ...
                    <div className="mt-2">
                      <form id="form">
                        ...
                        >
                          ...
                          <div className="div">
                            <h5 className={`${cfPassword ? "hidden" : ""}`}>
                              新パスワード確認
                            </h5>
                            <input
                              onChange={(e) => {
                              ...
                              required
                              onFocus={() => {
                                setIsCFPassFocus(true);
                              }}
                              onBlur={() => {
                                setIsCFPassFocus(false);
                              }}
                              name="password"
                            />
                          </div>
